...
@pytest.mark.asyncio
async def test_create_assignment_success_and_events(client):
...
@pytest.mark.asyncio
async def test_duplicate_active_assignment_rejection_responder(client):
...
@pytest.mark.asyncio
async def test_duplicate_active_assignment_rejection_incident(client):
...
@pytest.mark.asyncio
async def test_offline_responder_rejection(client):
...
@pytest.mark.asyncio
async def test_nonexistent_incident_and_responder_rejection(client):
...
@pytest.mark.asyncio
async def test_terminal_incident_assignment_rejection(client):
...
@pytest.mark.asyncio
async def test_full_assignment_lifecycle_progression(client):
...
@pytest.mark.asyncio
async def test_assignment_cancellation_lifecycle(client):
...
@pytest.mark.asyncio
async def test_authorization_checks(client, citizen_headers):
...
@pytest.mark.asyncio
async def test_assignment_listing_and_incident_query(client):
...
@pytest.mark.asyncio
async def test_transactional_rollback_on_assignment_creation_failure(client):
