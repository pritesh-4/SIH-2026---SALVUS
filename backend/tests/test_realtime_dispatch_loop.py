...
@pytest.mark.asyncio
async def test_assignment_triggers_realtime_event_broadcast():
...
@pytest.mark.asyncio
async def test_responder_location_update_emits_telemetry():
...
@pytest.mark.asyncio
async def test_responder_lifecycle_progression_loop():
