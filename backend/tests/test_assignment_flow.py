...
@pytest.mark.asyncio
async def test_get_candidates_with_explanations():
...
@pytest.mark.asyncio
async def test_atomic_assignment_and_lifecycle_advancement():
...
@pytest.mark.asyncio
async def test_routing_api_endpoints():
...
@pytest.mark.asyncio
async def test_simulation_step_endpoint():
